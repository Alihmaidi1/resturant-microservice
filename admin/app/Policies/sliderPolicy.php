...
class sliderPolicy
{
    ...
    public function update(admin $admin,array $injected)
    {
        ...
        $slider=slider::find($injected["id"]);
        if($admin->resturant_id==$injected["resturant_id"]&&$slider->resturant_id==$admin->resturant_id){
    ...
    public function delete(admin $admin,array $injected)
    {
        ...
        $slider=slider::find($injected["id"]);
        if($slider->resturant_id==$admin->resturant_id){
